...
# @Time         : 18/08/2022 21:02
# @Author       : tl22089
# @File         : federated_metric.py
...
if __name__ == '__main__':
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        for idx in idxs_users:
            local_model = LocalUpdate(args=args, dataset=train_dataset,
                                      idxs=train_groups[idx], logger=logger, kw=kw)
    ...
    torch.save(global_model.state_dict(), '../save/fed_metric_{:}.pt'.format(args.model))
