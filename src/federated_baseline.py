...
from rff.update import test_inference, LocalUpdate
...
if __name__ == '__main__':
    ...
    torch.save(global_model.state_dict(), '../save/fed_baseline_{:}.pt'.format(args.model))
    ...
    file_name = '../save/objects/fed_baseline_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}].pkl'. \
    ...
    plt.savefig('../save/fed_baseline_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_loss.png'.
    ...
    plt.xlabel('Communication Rounds')
    plt.savefig('../save/fed_baseline_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_acc.png'.
                format(args.dataset, args.model, args.epochs, args.frac,
                       args.iid, args.local_ep, args.local_bs))
